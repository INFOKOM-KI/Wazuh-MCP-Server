...
# export BLUETEAM_LAYA_TEMPERATURE="0.05"        # softmax sharpening; calibrate with the floor (scripts/calibrate_labeler.py)
...
for _envf in "$CONFIG_FILE" "$ENV_FILE"; do
  ...
  _sync_env_key "$_envf" "BLUETEAM_LAYA_TEMPERATURE" "${BLUETEAM_LAYA_TEMPERATURE:-0.05}"
...
export BLUETEAM_LAYA_TEMPERATURE="${BLUETEAM_LAYA_TEMPERATURE:-0.05}"
