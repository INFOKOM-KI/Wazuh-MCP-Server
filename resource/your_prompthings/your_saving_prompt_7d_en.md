...
6. **Recommended actions** — concrete next steps (watch, investigate, escalate). If a confirmed external IOC is worth sharing, propose a STIX 2.1 bundle with `blueteam_stix_export` (TLP:AMBER by default) and give the operator the file path.
