...
| Pelaporan & intelijen | `blueteam_curated_threat_report`, `blueteam_threat_hunt`, `blueteam_semantic_search`, `blueteam_mitre_lookup`, `blueteam_asset_context`, `blueteam_extract_iocs`, `blueteam_ioc_lifecycle`, `blueteam_ioc_search`, `sangfor_blocklist_check`/`_list`, `blueteam_metrics`, `blueteam_playbook_run` |
