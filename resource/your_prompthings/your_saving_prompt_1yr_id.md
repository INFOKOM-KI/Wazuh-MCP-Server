...
| Intel ancaman | `blueteam_threat_intel_aggregate`, `blueteam_unified_threat_score`, `crowdsec_ip_reputation`, `crowdsec_ip_reputation_bulk`, `threatfox_ioc_search`, `threatfox_ioc_search_bulk`, `otx_lookup`, `otx_lookup_bulk`, `greynoise_ip_context`, `argus_ip_lookup`, `netra_ip_analysis`, `urlhaus_lookup`, `urlhaus_lookup_bulk`, `urlhaus_hash_lookup`, `jarm_fingerprint`, `blueteam_ioc_search` (metered, RapidAPI), `blueteam_lookup_domain_virustotal`, `blueteam_lookup_hash_virustotal`, `blueteam_ai_bot_recon`, `blueteam_misp_ioc_lookup` |
